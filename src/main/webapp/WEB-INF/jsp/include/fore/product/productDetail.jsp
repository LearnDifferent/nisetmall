...
<div class="productDetailDiv" >
	<div class="productDetailTopPart">
		...
		<a href="#nowhere" class="productDetailTopReviewLink">Customer reviews <span class="productDetailTopReviewLinkNumber">${p.reviewCount}</span> </a>
	</div>
	
	
	<div class="productParamterPart">
		<div class="productParamter">Technical Details:</div>
